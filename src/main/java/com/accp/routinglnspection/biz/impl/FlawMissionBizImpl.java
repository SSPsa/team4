...
//   分页查询
    public Pager<FlawMission> queryFlawMisPager(int pageNo, int pageSize, String fmNumber, String fmName, int fmState, int principalUid, Date startTime, Date endTime) {
        ...
        flawMissionPager.setTotalRows(flawMissionDao.queryFlawMisRows(fmNumber,fmName,fmState,principalUid,startTime,endTime));
        flawMissionPager.setTotalPage( (flawMissionPager.getTotalRows() + pageSize-1)/ pageSize);
        int begin=(pageNo-1)*pageSize;
        flawMissionPager.setDatas(flawMissionDao.queryFlawMisPager(begin,pageSize,fmNumber,fmName,fmState,principalUid,startTime,endTime));
