        ...
        <div class="content">
            ...
            <form class="layui-form">
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <select>
                            ...
                            <option selected="selected">任务单</option>
                            <option>第一种单据</option>
                            <option>第二种单据</option>
                        </select>
                    </div>
                    ...
                    <div class="layui-input-inline">
                        <select>
                            ...
                            <option selected="selected">线路管理员测试用户01</option>
                            <option selected="selected">线路管理员测试用户02</option>
                            <option selected="selected">线路管理员测试用户03</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <textarea name="" cols="25" rows="5" placeholder="无"></textarea>
                    </div>
                ...
                <div class="layui-form-item">
                    ...
                    <div class="layui-input-inline">
                        <textarea name=""  cols="25" rows="5" placeholder="线路管理员测试用户01、
                        线路管理员测试用户02、线路管理员测试用户03"></textarea>
                    </div>
                </div>
            <div class="layui-form-item">
