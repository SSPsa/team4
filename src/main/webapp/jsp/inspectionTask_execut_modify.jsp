    ...
    <table class="layui-table">
        ...
        <td>
            <select name="" class="layui-input">
                <option value="" selected>叉梁断裂其他</option>
        ...
        <tr>
            <td>完好率:</td>
            <td><input type="text" class="layui-input" value="78%"></td>
            <td>发现时间:</td>
            <td>2013-12-12</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                <textarea name="" class="layui-input" style="width: 200px;height: 100px">无</textarea>
            </td>
