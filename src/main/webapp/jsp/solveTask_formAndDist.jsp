...
<div class="page-content">
    <div class="content">
        消缺任务管理>>消缺任务制定与分配
        <!-- 右侧内容框架，更改从这里开始 -->
        <form class="layui-form xbs" action="/flawMission/flawMissionPager" method="post">
            <div class="layui-form-pane" style="text-align: center;">
                <div class="layui-form-item" style="display: inline-block;">
                    <input type="hidden" name="pageIndex" value="1">
                    <label class="layui-form-label xbs768">任务编号：</label>
                    <div class="layui-input-inline xbs768">
                        <input name="fmNumber" class="layui-input" placeholder="请输入任务编号...">
                    </div>

                    <label class="layui-form-label xbs768">任务名称：</label>
                    <div class="layui-input-inline xbs768">
                        <input name="fmName" class="layui-input" placeholder="请输入线路编号...">
                    </div>
                ...
                <%--新增的模块--%>
                    <div class="layui-form-item" style="display: inline-block;">
                        ...
                        <div class="layui-input-inline">
                            <input name="startTime" class="layui-input"  id="LAY_demorange_s">
                        </div>
                        <label  class="layui-form-label">
                            <span class="x-red">-</span>
                        </label>
                        <div class="layui-input-inline">
                            <input name="endTime" class="layui-input"  id="LAY_demorange_e">
                        </div>
                    <div class="layui-input-inline" style="width:80px">
